...
print_color "default" ""
print_color "red" "Logging Pod : Check elastic search pods in logging name space : 3 pods (the same number of nodes)"
print_color "green" "${logging_pod}"
print_color "default" ""
print_color "red" "Kibana service pod : 1 pod "
print_color "green" "${kibana_service}"
print_color "default" ""
print_color "red" "Jaeger service pod : 2 pods"
print_color "green" "${jaeger_service}"
print_color "default" ""
print_color "red" "Monitoring pod (Grafana and alert manager) : 8 pods, make sure every pods are running status"
print_color "green" "${monitoring_service}"
print_color "default" ""
...
print_color "green" "####################################################"
print_color "default" ""
print_color "red" "VIP Auth Hub Service pod: 2 pod are complete status and 17 pods are running"
...
print_color "default" ""
print_color "default" " wget https://${SSP_FQDN} "
wget https://${SSP_FQDN} 
print_color "default" ""
print_color "default" ""
...
print_color "default" ""
print_color "red" " FIDO Domain Information"
print_color "default" ""
print_color "green" "$(if [ ! -z "${SSP_AT}" ]; then curl -s --insecure -L -X GET "https://${SSP_FQDN}/default/admin/v1/FIDORelyingParties" -H 'Content-Type: application/json' -H "Authorization: Bearer ${SSP_AT}" | jq . ; else echo "***** ERROR: SSP Access Token is not availabe ************"; fi)"
print_color "default" ""
print_color "green" "####################################################"